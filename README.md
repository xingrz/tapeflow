...
`python3 tapeflow-<version>.pyz verify <master>`. (`verify` is a read-only audit of one finished file —
handy for triage; `analyze` the source captures for the best-achievable completeness. HDV verify is
